...
("TOU"), including Kindista's " [Privacy Policy](/privacy) 
...
1. **Definitions.**
    ...
    1.  A "Member" is a User who registers for an account, creates a profile, or
        posts content to the Site.

    1.  A "Project" is a temporary or ongoing group endeavor. 
        Members can create Project profiles on the Site to represent businesses,
        organizations, collectives, associations, cooperatives, or other groups.
        Project profiles allow groups of Members to offer and give Gifts of 
    ...
    1.  A "Request" is a description of a resource that a User 
        ;or Project 
        would like to receive from another User 
        ;or Project
        as a gift. 
        Users can browse and search for Requests posted on Kindista. 
        If you post an Request, other Users may contact you to offer you the 
        Request. 
        It is up to you to decide to whether or not to accept an offer from 
    ...
    1.  "Kindista" means features, functionality, and services we make available, 
    ...
    1.  "CommonGoods" and references to "us," "we," or "our" mean CommonGoods 
        Network, Inc. Commongoods is a 501(c)(3) charitable organization and 
        the parent organization of Kindista.
<a id="restrictions"></a>

1.  **Restrictions on Use.**

    **Do not engage in activities that may betray the trust, 
    ...
    1.  **Do not engage in harassment, discrimination, abuse, or hostility towards other Users.**
        - Do not post content or messages that are malicious, hateful, 
          inflammatory, discriminatory, divisive, or bigoted.
        - Do not use the Site to threaten, stalk, defraud, incite, harass, 
          or advocate the harassment of another person, or otherwise 
          interfere with a User's enjoyment of the Site.
        - Do not use Kindista to transmit or post spam, chain letters, 
          contests, junk email, pyramid schemes, or similar mass messaging, 
          whether commercial in nature or not.
        
    1.  **Do not engage in false statements, impersonation, or fraud.**
        - Do not intentionally post libelous, inaccurate, 
          exaggerated, or false information about 
          yourself 
          ;, Projects,
          or other people on the Site. 
        - Do not create multiple accounts for yourself 
          ;, a Project 
          or another Member on the Site.
        - Do not create shadow or dummy accounts for non-existent Users 
          ;or Projects 
          for the purpose of developing a false reputation, or for 
          any other purpose.
        - Do not use the Site to falsely represent yourself as 
          ;either an administrator or member of a Project, or
          an agent of another User.

    1.  **Do not use the Site in violation of the TOU or any 
          applicable local, state, national or international law.**
        - Do not solicit personally identifiable information from anyone under 
          the age of 18 for an illegal purpose or violating any applicable law 
          regarding the health or well-being of minors.
        - Do not post child pornography or any content that violates applicable 
          law concerning child pornography.
        - Do not solicit illegal items or materials.
        - Do not post obscene material that is unlawful under applicable law.

    1.  **Do not engage in disruptive, malicious, or illegal misuse of facilities.**
        - Do not access, crawl, or index any portion of the Site for 
          purposes of constructing or populating a searchable database of 
          Content from the Site.
        - Do not make any action that imposes, or may impose in our sole 
        ...
        - Do not use the Site to transmit any viruses, worms, 
          defects, Trojan horses, spyware, or otherwise malicious computer 
          code.
        - Do not disrupt or interfere with the security or proper 
...
1.  **Responsibility for Your Content.**
    ...
    1.  You are solely responsible for Your Content and its accuracy. 
...
1.  **Member Accounts.**
    ...
    To access or use many of the Services, you will be required to 
    ...
    ; A "Project Account" is an account for use on the Site as a 
    ...
    ; "create multiple Project Accounts for the same Project.</u>
    ; **If you are using Kindista on behalf of a business, that business 
    ; accepts these terms.** 
    
1.  **Licenses.**

    When you post Content to Kindista, 
    ...
    - When you submit Content to Kindista, 
    ...
    - Make sure you have the necessary rights 
      ...
      You can find more information about how Kindista uses and stores content in the 
      [Privacy Policy]((/privacy).
...
1.  **Changes to the TOU or the Site.**
    The TOU may be modified by Kindista at any time. 
    When these changes are made, Kindista will notify you by making a new copy of the 
    TOU available on this page and will indicate at the top of this page the date these 
    terms were last revised. 
    Any such modification will be effective upon Kindista's posting of new TOU. 
    Your continued use of the Site after any posted modification to the TOU indicates 
...
1.  **Unauthorized Access.**
    CommonGoods reserves the right to exercise whatever lawful means it deems necessary 
    to prevent unauthorized access to or use of the Site, including, but not limited to, 
    technological barriers, IP mapping, and contacting your Internet Service Provider 
    (ISP) regarding such unauthorized use.

1.  **Feedback.**

    1. _Dissatisfaction._ If you are dissatisfied with the Site, please let us know by 
    providing feedback through our contacts page. 
    Your input is valuable to us.
    1. _Suggestions and Improvements._
    By submitting ideas, suggestions, documents and/or proposals ("Feedback") to Kindista 
    through its suggestion, feedback, forum or similar web pages, you acknowledge and agree that:

        1.  your Feedback does not contain the confidential or proprietary information of 
            third parties;
        1.  CommonGoods is not under any obligation of confidentiality with respect to the 
            Feedback;
        1.  CommonGoods shall be entitled to use and disclose such Feedback for any purpose, 
            in any way, in any media worldwide; and
        1.  your Feedback does not entitle you to any compensation or reimbursement of any 
            kind from CommonGoods under any circumstances.

1.  **Termination.**
    CommonGoods reserves the right to terminate or suspend your account or your ability to 
    use the Site, in whole or in part, if it discovers that you have violated the TOU.
     
    Termination of your account may include: 
 
    - removal of access to all offerings within Kindista;
    - deletion of your password and all related information, files and materials associated 
      with or inside your account (or any part thereof), including Your Content; and 
    - barring of further use of Kindista.

     You agree that CommonGoods shall not be liable to you or any third party for any 
...
1.  **Copyright Complaints**
    ...
    Please note that CommonGoods may, at its sole discretion, send a 
    copy of such notices to third-parties, such as 
    [Chilling Effects](http://www.chillingeffects.org),
    for publication (with personal information removed).

    Please see [17 U.S.C. §512(c)(3)] (http://www/copyright.gov/title17/92chap5.html)
    ...
    _Address for Designated Agent._ Please contact CommonGoods's Designated Agent at the 
    following address:

    CommonGoods Network<br>
    Designated Agent, Copyright Issues<br>
    PO Box 5034<br>
    Eugene, OR 97405

    Email to: legal@commongoods.net

1.  **Disclaimers.**

    1. THE SITE AND ALL SITE CONTENT IS MADE AVAILABLE TO YOU ON AN "AS IS" BASIS. 
    ...
    1. COMMONGOODS SPECIFICALLY DISCLAIMS ALL LIABILITY RELATING TO YOUR USE OF THE SITE, 
       SERVICES, AND SITE CONTENT. 
       ACCESS TO, AND USE OF, THE SITE, SERVICES, AND SITE CONTENT ARE AT YOUR OWN DISCRETION 
       AND RISK, AND YOU WILL BE SOLELY RESPONSIBLE FOR ANY DAMAGE TO YOUR COMPUTER SYSTEM OR 
       LOSS OF DATA RESULTING THEREFROM. 
       COMMONGOODS ASSUMES NO LIABILITY FOR ANY COMPUTER VIRUS OR SIMILAR CODE THAT IS 
       DOWNLOADED TO YOUR COMPUTER FROM THE SITE OR IN CONNECTION WITH THE SERVICES.
    1. YOUR COMMUNICATIONS OR DEALINGS WITH ANY OF 
       ;THE PROJECTS OR 
       USERS ON THE SITE, ARE SOLELY BETWEEN YOU AND SUCH 
       ;PROJECTS AND 
       USERS. 
       COMMONGOODS IS NOT RESPONSIBLE, AND DISCLAIMS ALL LIABILITY, FOR ANY LOSS OR 
       DAMAGE ARISING OUT OF ANY SUCH COMMUNICATIONS OR DEALINGS. COMMONGOODS RESERVES 
       THE RIGHT (BUT HAS NO OBLIGATION) TO MONITOR DISPUTES BETWEEN YOU AND SUCH 
       ;PROJECTS AND 
       USERS.
    1. SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OF CERTAIN WARRANTIES, 
       REPRESENTATIONS, OR CONDITIONS, THE LIMITATION OR EXCLUSION OF IMPLIED WARRANTIES, 
       OR LIMITATIONS ON HOW LONG AN IMPLIED WARRANTY MAY LAST, SO THE ABOVE LIMITATIONS 
       MAY NOT APPLY TO YOU. 
       IF YOU RESIDE IN SUCH A JURISDICTION, THE ABOVE LIMITATIONS SHALL APPLY TO YOU TO 
...
1.  **Third Parties.**
    ...
    The Site uses a mapping feature powered by Google Inc. Your use of 
    the mapping feature is governed by Google Inc.'s terms of use 
    located at 
    [http://maps.google.com/help/terms_maps.html](http://maps.google.com/help/terms_maps.htmli)
    (or such other URL as may be updated by Google Inc.).

1.  **Miscellaneous.**

    1.  No agency, partnership, joint venture, or employment is created as 
        a result of the TOU, and you do not have any authority of any kind 
        to bind CommonGoods in any respect whatsoever.
    1.  Kindista may provide you with notices, including those regarding 
        changes to the TOU by email, regular mail or postings on the 
        Site.
    1.  Except as otherwise stated in Section 18 above, nothing herein is intended, 
        nor will be deemed, to confer rights or remedies upon any third party.
    1.  The TOU and Privacy Policy contain the entire agreement between 
        ...
        matter.
    1.  The failure of CommonGoods to exercise or enforce any right or provision of the 
        TOU shall not constitute a waiver of such right or provision. The failure of 
    ...
    1.  If any provision of the TOU is found to be unenforceable or invalid, that 
        provision shall be limited or eliminated to the minimum extent necessary so 
        that the TOU shall otherwise remain in full force and effect and enforceable.
    1.  The TOU are not assignable, transferable or sub-licensable by you except with 
        CommonGoods's prior written consent or as expressly indicated above. 
    ...
    1.  The section titles in the TOU are for convenience only and have no legal or 
        contractual effect.

1.  **Contact and Violations.**
